...
We can observe that the loading operations for each plant are non-overlapping and the unloading operations occur sequentially, one after the other, at the worksite. Plant $0$ is in charge of both orders of customer $8$. In figure~\ref*{fig:plant0}, order $o_9$ is served before $o_8$. Each row on the figure represents a pair of loading and unloading task for a delivery. Figure~\ref*{fig:plant2} shows how the loading bay is alternately assigned to orders $o_{13}$ and $o_7$ between $10:00$ and $15:30$ a.m.

We report for the instance $C29\_10\_14\_3$ a $FDD$ of $49.6$ minutes. The gantt chart indicates that customers $4,5$ and $8$ whom need their delivery at $07:00$ a.m. have all a first late delivery. The reason for these delays is that no 

...
In this section, we analyse the impact on the solution when we change some parameters of our problem, and run the GRASP algorithm with the local search step. 

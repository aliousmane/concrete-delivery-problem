...
struct network_arc_t {
  ...
  char can_visit;
  network_arc_t()
      : id(-1), from(-1), to(-1), marked(0), value(0), can_visit(1) {}
...
struct network_bfs_report_t {
  ...
  network_bfs_report_t()
      : nb_marked_nodes(0), nb_marked_arcs(0), nb_positive_arcs(0),
        nb_marked_positive_arcs(0), nbnodes(0), nbarcs(0) {}
  void init() {
    nbnodes = 0;
    nbarcs = 0;
    nb_marked_nodes = 0;
  ...
  void print() {
    printf("nbnodes:%d nbarcs:%d nb_marked_nodes:%d 	nb_marked_arcs:%d "
           "nb_positive_arcs:%d nb_marked_positive_arcs:%d\n",
           nbnodes, nbarcs, nb_marked_nodes, nb_marked_arcs, nb_positive_arcs,
           nb_marked_positive_arcs);
  }
};
